...
type Disciplina struct {
	...
	// Relacionamentos
	Alunos    []Aluno   `gorm:"many2many:aluno_disciplina;foreignKey:Id;joinForeignKey:DisciplinaId;References:Id;joinReferences:AlunoId;constraint:OnDelete:CASCADE"`
