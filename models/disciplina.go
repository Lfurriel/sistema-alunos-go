...
type Disciplina struct {
	...
	ProfessorId           string    `json:"professor_id" gorm:"not null;column:professor_id" binding:"-"` // FK
	AnoSemestre           string    `json:"ano_semestre" gorm:"not null;column:ano_semestre" binding:"required,ano_semestre"`
	QuantidadeAlunos      int       `json:"quantidade_alunos" gorm:"not null;column:quantidade_alunos;default:0" binding:"-"`
	QuantidadeProvas      int       `json:"quantidade_provas" gorm:"not null;column:quantidade_provas;default:0" binding:"-"`
	QuantidadeTrabalhos   int       `json:"quantidade_trabalhos" gorm:"not null;column:quantidade_trabalhos;default:0" binding:"-"`
	...
	CargaHorariaRealizada int       `json:"carga_horaria_realizada" gorm:"not null;column:carga_horaria_realizada;default:0" binding:"-"`
